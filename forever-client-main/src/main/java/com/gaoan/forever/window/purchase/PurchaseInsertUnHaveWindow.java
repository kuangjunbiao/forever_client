...
public class PurchaseInsertUnHaveWindow {

	private static final Logger logger = LoggerFactory.getLogger(PurchaseInsertUnHaveWindow.class);

	private static final String INSERT_PURCHASE_URL = ServerApiConfig.getApiInsertPurchaseOrderByUnHave();
	...
	public static void show(JFrame relativeWindow, RepaintContentParamVo<PurchaseOrderInfoModel> parentParamVo) {
		// 创建一个新窗口
		JFrame insertJFrame = new JFrame(MessageInfoConstant.INSERT_UNHAVE);
		...
		JTextField purchaseNameText = new JTextField();
		purchaseNameLabel.setBounds(80, 20, 80, 35);
		purchaseNameText.setBounds(160, 25, 140, 25);

		// 商品BOX
		JLabel goodsNameLabel = new JLabel(MessageInfoConstant.GOODS_NAME);
		JTextField goodsNameText = new JTextField();
		goodsNameLabel.setBounds(80, 60, 80, 35);
		goodsNameText.setBounds(160, 65, 140, 25);
		...
		panel.add(purchaseNameText);
		panel.add(goodsNameLabel);
		panel.add(goodsNameText);
		...
		currParamVo.setPurchaseNameText(purchaseNameText);
		currParamVo.setGoodsNameText(goodsNameText);
	...
	public static void addListener(RepaintContentParamVo<PurchaseOrderInfoModel> currParamVo,
		...
		JTextField purchaseNameText = currParamVo.getPurchaseNameText();
		JTextField goodsNameText = currParamVo.getGoodsNameText();
		...
		confirmBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String purchaseName = purchaseNameText.getText();
