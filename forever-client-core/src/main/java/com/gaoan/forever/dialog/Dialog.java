...
public class Dialog {
	...
	public static final Logger logger = LoggerFactory.getLogger(Dialog.class);
	...
	public static int showConfirmDialog(JFrame jf, String title, String message) {
		/*
